...
export function QuestionCircleIcon({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function AlertOctagonIcon({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function TableIcon({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M12 3v18" />
...
export function SatelliteIcon({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function MaximizeIcon({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
